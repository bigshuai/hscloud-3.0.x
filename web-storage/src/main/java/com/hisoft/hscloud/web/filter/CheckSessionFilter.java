...
public class CheckSessionFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		validateUrl(httpRequest, httpResponse, "/console/",Constants.LOGIN_CURRENTUSER);
	...
	private void validateUrl(HttpServletRequest httpRequest,
			...
			String... sessionNames) throws IOException {
	...
	private boolean existOnSession(HttpServletRequest httpRequest,
		...
		for (String sessionName : sessionNames) {
			flag = flag
					&& (httpRequest.getSession().getAttribute(sessionName) == null);
		}
		return flag;
	}
	...
	private boolean isCheckingPath(HttpServletRequest httpRequest, String path) {
		...
		String contextPath = httpRequest.getContextPath() + path;
