...
public class Constants {
	...
	public static String VM_TryEXTRA_LONG="03095";//延期总时长超出限时30天
	...
	public static final String ONLYTRY_SC_ERROR="SC009";
	//siteconfig
...
*/    
    ...
    //smsMessage Exception
    public static final String SMSMESSAGE_SAVE_EXCEPTION = "SMS00001";//发送信息异常
    public static final String SMSMESSAGE_DEL_EXCEPTION = "SMS00002";//删除发送信息异常
    public static final String SMSMESSAGE_SHOW_EXCEPTION = "SMS00003";//显示发送信息异常
    
    //app账单异常
    public static final String APPBILL_PAGE_EXCEPTION = "appBill00001";//获取分页信息异常
    public static final String APPBILL_SAVE_EXCEPTION = "appBill00002";//保存账单异常
    public static final String APPBILL_EXPORTEXCEL_EXCEPTION = "appBill00003";//导出账单异常
    
    //app账单异常
    public static final String APPORDER_PAGE_EXCEPTION = "appOrder00001";//获取分页信息异常
    public static final String APPORDER_GET_EXCEPTION = "appOrder00002";//获取指定订单异常
    public static final String APPORDER_CANCEL_EXCEPTION = "appOrder00003";//取消订单异常
  
    //app报表
    public static final String GET_REPORT_EXCEPTION = "appReport00001";//获取信息异常
...
//    public static final String PAYMENT_RETURN_URL="/bss/paymentResponse.action";
    //wgsg测试用
    public static final String PAYMENT_NOTIFY_URL="/payment/response";
    public static final String PAYMENT_RETURN_URL="/payment/asynResponse";
    ...
    public static final String RABBITMQ_LOG = "LogBean";
    ...
    //add by liutao
    public static final String APPLIACTION_NO_APPLY = "10";//未申请
    public static final String APPLIACTION_SUBMIT_APPLY = "20";//已申请
    public static final String APPLIACTION_UP = "30";//上架
    public static final String APPLIACTION_DOWN = "40";//下架
    public static final String APPLIACTION_REFUSE = "50";//拒绝
    //管理员ID
    public static final Integer ADMINISTRATOR_ID = 0;
    public static final Integer DELETE_STATUS_ZERO = 0;//有效
    public static final Integer DELETE_STATUS_ONE = 1;//删除
    
    public static final Integer APPLIACTION_RECOMMEND_ONE = 1;//推荐商品
    
    public static final Integer WORK_ORDER_ONE = 1;//工单管理云应用工单
    
    public static final Integer WORK_ORDER_ZERO = 0;//工单管理云商城工单
    
    public static final Integer WORK_ORDER_ATUO_MANUAL = 0;//工单管理-自动
    
    public static final Integer WORK_ORDER_CREATE_MANUAL = 0;//工单管理-手动
    
    public static final Integer WORK_ORDER_STATUS_ONE = 1;//工单管理状态--已提交未回复
    
    public static final Integer WORK_ORDER_STATUS_TWO = 2;//工单管理状态--已回复
    
    public static final Integer WORK_ORDER_STATUS_THREE = 3;//工单管理状态--已撤销
    
    public static final Integer MATERIAL_STATUS_ONE =1;//MATERIAL状态--应用logo
    
    public static final Integer MATERIAL_STATUS_TWO =2;//MATERIAL状态-应用微信图片
    
    public static final Integer MATERIAL_STATUS_THREE =3;//MATERIAL状态-界面截图
    
    public static final float APPLICATION_DIVIDE_PROPORTION =0.7f;//MATERIAL状态-界面截图
