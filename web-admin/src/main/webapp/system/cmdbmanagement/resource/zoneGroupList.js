...
var zoneGroupModel=Ext.define('zoneGroupModel', {
	...
	fields: ['id', 'name', 'createId','code','description','isEnable','domainList',
            	   ...
            	   listeners: {                                            
            		   ...
            		   "click" : function() {
            			   ...
            			   if(isEnable==0){
							...
							var description = record.get('description');												                                                
							showRelatedOsWin(id,zoneGroupName);
            		   }
            	   }
               },
               {
		...
		columns: [
		          ...
		          },                                  
		          {
		        	  ...
		        	  renderer :function(data, metadata, record, rowIndex, columnIndex, store){
		        		  ...
		        		  return Ext.util.Format.ellipsis(data,15);							
		        	  }
		          }]
});
...
function showRelatedOsWin(zoneGroupId,groupName){
	var unRelatedOsStore=Ext.create('Ext.data.Store',{
		  pageSize: pageSize,
	      model: 'osModel',
	      proxy: new Ext.data.proxy.Ajax({
	      	url: path+'/../../sc/zoneGroup!findUnRelatedServerOsByPage.action?zoneGroupId='+zoneGroupId,
			reader: {
	              type: 'json',
	              root: 'resultObject.result',
	              totalProperty: 'resultObject.totalCount'
