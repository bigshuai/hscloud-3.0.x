...
var aitem1 = Ext.create('Ext.Panel',{
	 id:"aitem1",
	 title:"<center ><span id='m1' style='width:100%;color:#ffffff;font-size:14px;font-family:微软雅黑;'>"+i18n._('vmmanagement')+"</span></center>",
	 //autoScroll:true,
	 hideCollapseTool:true,
	 bodyStyle:'background:#0e3c72!important',
	 layout:'fit',
