...
//						nodeIPMIPasswordContainer.setVisible(true);
				...
				{					
					...
					handler : function() {
						...
						nodeZoneField.setValue(rows[0].get('zoneName'));
...
//						nodeIPMIPasswordContainer.setVisible(false);
	...
	},//		
	{
		...
		renderer : function(value) {
			if (value == 'true') {
				return i18n._('ACTIVE');//良好
			} else {
				return i18n._('ERROR')//错误
			}
	...
	},//
	{
		...
		hidden:true,
		//width : 200,
		renderer : renderDescnRate

	}, {
		header : i18n._('Operating'),
		dataIndex : 'isEnable',
		flex : 0.12,
		sortable: true,
		renderer : function(value) {
	...
	{
		header : i18n._('IPMI'),
		dataIndex : 'hostIpmiInfo',
		flex : 0.16,
		//width : 200,
		renderer : renderDescnIPMI
