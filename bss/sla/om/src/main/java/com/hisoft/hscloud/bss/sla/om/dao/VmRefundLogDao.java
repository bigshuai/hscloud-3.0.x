...
public interface VmRefundLogDao {
	/**
	 * <保存退款日志信息> 
	* <功能详细描述> 
	* @param vmRefundLog 
	...
	* @see [类、类#方法、类#成员]
	 */
	public List<VmRefundLogVO> vmRefundLogPaging4Website(Short status,String query,Page<VmRefundLogVO> paging,Long userId)throws HsCloudException;
	/**
	 * <分页获取退款日志信息-获取总数> 
	* <功能详细描述> 
	* @param status
