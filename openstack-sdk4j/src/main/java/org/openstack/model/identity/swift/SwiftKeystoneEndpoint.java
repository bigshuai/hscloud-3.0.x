...
public class SwiftKeystoneEndpoint implements Endpoint, Serializable {
	...
	public SwiftKeystoneEndpoint() {
		
	}
	
	public SwiftKeystoneEndpoint(String id, String region, String serviceId) {
		this.id = id;
		this.region = region;
