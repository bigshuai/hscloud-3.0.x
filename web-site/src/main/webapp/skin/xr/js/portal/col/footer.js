$(document).ready(function() {
	...
	initCss('portal/col/footer.css');
	$("#footer").css("background","url(../skin/"+customerPath+"/images/portal/col/footer_bg.png)");
	/*if($("#content").height()+125+50>document.body.clientHeight){
