/* 
* 文 件 名:  PlatformRelationService.java 
 ...
 * @since  [产品/模块版本] 
 */
public interface PlatformRelationService {
	...
	* @see [类、类#方法、类#成员]
	 */
	public PlatformRelation getPlatformRelationByLocalUser(String localUser) throws HsCloudException;
	/**
	 * <根据客户用户userId查询关联信息> 
	* <功能详细描述> 
	* @param externalUser
	...
	* @see [类、类#方法、类#成员]
	...
	public String deletePlatformRelation(PlatformRelation platformRelation) throws HsCloudException;
}
