/* 
* 文 件 名:  NETMonitorDetailBean.java 
 ...
 * @since  [产品/模块版本] 
 */
public class NETMonitorDetailBean implements Serializable{

	/** 
	* 注释内容 
	*/
	private static final long serialVersionUID = 8222370691134330075L;
	...
	private List<NETSingleDetailBean> singleDetailBeanList =new ArrayList<NETSingleDetailBean>();
	...
	public List<NETSingleDetailBean> getSingleDetailBeanList() {
		return singleDetailBeanList;
	}
	public void setSingleDetailBeanList(
			List<NETSingleDetailBean> singleDetailBeanList) {
