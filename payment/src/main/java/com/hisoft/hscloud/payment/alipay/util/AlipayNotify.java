...
public class AlipayNotify {
     ...
     * @return 验证结果
     */
    public static boolean verify(Map<String, String> params,String key,String partner)throws Exception {
...
//        AlipayCore.logResult(sWord);
     ...
     * @return 生成的签名结果
     */
    private static String getMysign(Map<String, String> Params,String key)throws Exception {
    ...
    */
    private static String verifyResponse(String notify_id,String partner)throws Exception {
    ...
    */
    private static String checkUrl(String urlvalue)throws Exception {
        ...
        try {
        	...
        	logger.error("response verify error when checkUrl",e);
        	inputLine = "";
        	throw new Exception("response verify error when checkUrl");
