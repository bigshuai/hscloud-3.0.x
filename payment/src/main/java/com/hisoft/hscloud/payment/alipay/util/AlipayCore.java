...
public class AlipayCore {
     ...
     * @return 签名结果字符串
     */
    public static String buildMysign(Map<String, String> sArray,String key)throws Exception {
     ...
     */
    public static Map<String, String> paraFilter(Map<String, String> sArray)throws Exception {
     ...
     */
    public static void logResult(String sWord) throws Exception{
